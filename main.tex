...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{assets/num_samples_comparison.png}\par\vspace{0.5cm}
    \caption{FID scores for datasets in different sizes. Here subsets of MS-COCO where used with 250 diffusion steps.}
...
We were also interested in the FID score when varying the number of diffusion steps. As we didn't have the computation power, to generate 5000 images per number of diffusion steps, we only used a subset of 2000 images of the MS-COCO dataset. 
